...
# Notation may still be a bit sloppy, don't always consistently label velocities
# as v1,v2,v3 or vx,vy,vz or vr,vphi,vz... however this is mostly unimportant
...
#======================== Halo integrals ======================================#
def gvmin_Isotropic(v_min,day=67.0,v_LSR=233.0,sig=164.75,v_esc=528.0,\
